...
{
    mat = Mat(v_rect, true);
    LOGD("dosJava_org_opencv_samples_facedetect_DetectionBasedTracker_nativeDetect detected");
}
...
(JNIEnv * jenv, jclass, jstring jFileName, jint faceSize)
{
    ...
    try
    {
        ...
        LOGD("azimJava_org_opencv_samples_facedetect_DetectionBasedTracker_nativeCreateObject enter");
    }
...
(JNIEnv * jenv, jclass, jlong thiz)
{
    ...
    try
    {
        if(thiz != 0)
        {
        	LOGD("altynJava_org_opencv_samples_facedetect_DetectionBasedTracker_nativeDestroyObject enter");
